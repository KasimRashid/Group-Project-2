// this is just like sorting2 but i used bublesort instead of simple sort. simple sort is still in this code just commented out. idk if my bubble sort algorithm is correct
#include <pthread.h>
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
//void quick_sort(int low, int high); // Quick Sort implementation  //-------------------change
...
void bubbleSort(int low, int high) {
    ...
    // Perform Bubble Sort on the result array
    for (int k = low; k < high; k++) {
        for (int q = low; q < high - (k - low); q++) {
